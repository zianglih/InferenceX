...
python3 "$CAMPAIGN_HELPER_ROOT/cli.py" check-execution --lock "$R8_EXECUTION_LOCK" --lock-sha "${R8_EXECUTION_LOCK_SHA256:?Missing activation SHA}"
...
source "$EXPERIMENT_DIR/common-recovery8.sh"
...
export CAMPAIGN_HELPER_ROOT R8_EXECUTION_LOCK R8_EXECUTION_LOCK_SHA256 R8_CAMPAIGN_WORKER_PID
