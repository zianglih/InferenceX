...
''', 1)
    ...
    old = old.replace(anchor, anchor + '''[[ "$CAMPAIGN_RUN_ID" == c2-w4a16-megamoe-autotune-20260921-recovery8 ]] || exit 1
...
if __name__ == '__main__':
    ...
    print(''.join(difflib.unified_diff(old.splitlines(True), wrapper().splitlines(True),
          fromfile='run_megamoe_recovery3.sh (frozen)', tofile='run_megamoe_recovery8.sh (disabled)')))
