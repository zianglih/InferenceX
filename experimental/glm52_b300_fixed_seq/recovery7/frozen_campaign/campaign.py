#!/usr/bin/env python3
"""Concrete recovery7 environment/contract wiring. No executable CLI activation."""
import argparse
import hashlib
import json
...
def campaign_environment(base, *, task_root, recipe_root, model_path, helper_root, activation_path):
    ...
    env.update(CAMPAIGN_TASK_ROOT=task_root, CAMPAIGN_MODEL_PATH=model_path,
        ...
        CAMPAIGN_HELPER_ROOT=helper_root, R7_CASE_ADAPTER=helper_root + '/case_entry.py',
        R7_EXECUTION_LOCK=activation_path, SGLANG_SOURCE_ROOT=task_root + '/sources/sglang',
