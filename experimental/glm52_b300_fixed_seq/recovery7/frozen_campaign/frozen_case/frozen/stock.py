...
TASK = '/data/home/ziangli/inferencex-glm52-megamoe-autotune-20260921-recovery7'
...
def child_environment(base,hook_dir,proof_lock,proof_sha):
    ...
    env.update(PYTHONDONTWRITEBYTECODE='1',PYTHONNOUSERSITE='1',
        ...
        MEGAMOE_R7_NATIVE_PROOF_LOCK=proof_lock,MEGAMOE_R7_NATIVE_PROOF_SHA256=proof_sha)
    return env
